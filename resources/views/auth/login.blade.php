...
<div class="flex max-w-sm mx-auto mt-16 overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
    <div class="hidden bg-cover lg:block lg:w-1/2" style="background-image:url('https://images.unsplash.com/photo-1618388810903-840bb0d15ea5?ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8bGFyYXZlbHxlbnwwfHwwfHw%3D&ixlib=rb-1.2.1&w=1000&q=80')"></div>
    ...
    <div class="w-full px-6 py-8 md:px-8 lg:w-1/2 ">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="block mt-4">
                ...
                <div class="mt-8">
                    <button class="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-blue-700 hover:bg-blue-400 rounded -600 focus:outline-none focus:bg-gray-600">
                        Login
                    </button>
                </div>
        </form>
