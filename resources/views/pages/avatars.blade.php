    ...
    <section class="flex bg-white">
        ...
        <section class="w-full h-full bg-white mt-10">
            ...
            <div class="w-full ml-30 gap-y-5 gap-x-2 text-right pr-36"">
                ...
                class="px-4 avatar py-2 font-medium text-white transition-colors duration-200 transform bg-gray-600 rounded-md dark:bg-gray-800 hover:bg-gray-500 dark:hover:bg-gray-700 focus:outline-none focus:bg-gray-500 dark:focus:bg-gray-700">
            ...
            <section class="container p-6 mx-auto bg-white dark:bg-gray-800">
                ...
                <div class="flex items-center justify-center">
                    <div class="grid gap-8 mt-8 sm:grid-cols-2  lg:grid-cols-2 xl:grid-cols-3">
                        ...
                        <div class="max-w-xs mx-auto avatar overflow-hidden bg-white rounded-lg shadow-2xl dark:bg-gray-800 ring-4 ring-indigo-300">
