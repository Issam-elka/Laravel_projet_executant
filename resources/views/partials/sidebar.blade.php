<div class="flex flex-col w-64 h-screen bg-gray-300 border-r dark:bg-gray-800 dark:border-gray-600  ">
    
    <div class="flex flex-col items-center mt-6  bg-gray-300">
        ...
        <p class="mx-2 mt-1 text-sm font-medium text-gray-600 dark:text-gray-400 hover:underline">
            {{ Auth::user()->email }}</p>
        <p class="mx-2 mt-1 text-sm font-medium text-gray-600 dark:text-gray-400 hover:underline">
            {{ Auth::user()->roles->role }}</p>
            <form method="POST" action="{{ route('logout') }}" class="flex text-white">
                @csrf
                <x-dropdown-link :href="route('logout')"
                onclick="event.preventDefault();
                                    this.closest('form').submit();" class="flex mt-4 rounded-md bg-red-400 hover:bg-red-200 ">
                                    Log out
    ...
    @if (Auth::user()->role_id == 1)
        ...
        <div class="flex flex-col justify-between flex-1 h-full mt-6">
            <nav>
                <a class="flex items-center px-4 py-2 text-gray-700 bg-gray-200 dark:bg-gray-700 dark:text-gray-200"
                    href="/dashboard">
                    <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
